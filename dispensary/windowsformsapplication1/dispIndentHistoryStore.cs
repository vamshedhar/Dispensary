...
{
    public partial class dispIndentHistoryStore : Form
    {
        string username;
        int i = 0;
        public dispIndentHistoryStore(string user)
        {
            InitializeComponent();
            username = user;
        }
        ...
        private void dispIndentHistoryStore_Load(object sender, EventArgs e)
        {
            ...
            comboBox1.SelectedItem = settings.PrinterName;
        }
        ...
        private void printDocument1_PrintPage(object sender, System.Drawing.Printing.PrintPageEventArgs e)
        {
            ...
            if (i == 0)
            {
                ...
                g.DrawString("DISPENSARY INDENT REPORT", messageFont, Brushes.Black, 60, 21);
                Pen blackPen = new Pen(Color.Black, 1);
                g.DrawLine(blackPen, 5, 28, 205, 28);
                messageFont = new Font("Times New Roman", 12, System.Drawing.GraphicsUnit.Point);
                g.DrawString("Indent No.: " + textBox1.Text, messageFont, Brushes.Black, 15, 32);
            ...
            g.DrawString("DispStock", messageFont, Brushes.Black, 147, total + 13);
            g.DrawString("QtyInd.", messageFont, Brushes.Black, 167, total + 13);
            g.DrawString("QtyIss.", messageFont, Brushes.Black, 186, total + 13);
            total += 25;
