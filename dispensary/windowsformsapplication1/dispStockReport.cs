...
{
    public partial class dispStockReport : Form
    {
        string username;
        int i = 0;
        int j = 1;
        public dispStockReport(string user)
        {
            InitializeComponent();
            username = user;
        ...
        private void dispStockReport_Load(object sender, EventArgs e)
        {
            yearsLoad();
            medicinesLoad();
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            medicinesLoad();
            textBox1.Text = "";
            //MessageBox.Show(DateTime.Today.AddMonths(1).ToString("yyyyMMdd"));
        }
        ...
        private void printDocument1_PrintPage(object sender, System.Drawing.Printing.PrintPageEventArgs e)
        {
            ...
            if (i == 0)
            {
                ...
                g.DrawString("DISPENSARY STOCK REPORT", messageFont, Brushes.Black, 65, 21);
            ...
            g.DrawString("Dispensary Stock", messageFont, Brushes.Black, 167, total + 13);
            total += 25;
        ...
        {
            if (MessageBox.Show("Are you sure you want to Print Current Stock Report??", "Pinrt today's Current Report??", MessageBoxButtons.YesNo) == DialogResult.Yes)
            {                
                try
                {
                    medicinesLoad();
        ...
        private void printDocument2_PrintPage(object sender, System.Drawing.Printing.PrintPageEventArgs e)
        {
            ...
            for (; i < dataGridView1.Rows.Count; i++)
            {
                ...
                medicine med = new medicine();
                med.dispDailyExpenses(dateTimePicker1.Value.Date.ToString("yyyyMMdd"), dataGridView1.Rows[i].Cells[0].Value.ToString());
        ...
        private void printDocument3_PrintPage(object sender, System.Drawing.Printing.PrintPageEventArgs e)
        {
            ...
            if (i == 0)
            {
                ...
                g.DrawString("INDIAN INSTITUTE OF TECHNOLOGY ROORKEE, SAHARANPUR CAMPUS", messageFont, Brushes.Black, 22, 15);
                messageFont = new Font("Times New Roman", 15, System.Drawing.GraphicsUnit.Point);
                g.DrawString("MONTHLY EXPENSE REPORT ("+monthCalendar1.SelectionStart.Date.ToString("MMMM, yyyy").ToUpper()+")", messageFont, Brushes.Black, 50, 21);
                Pen blackPen = new Pen(Color.Black, 1);
                g.DrawLine(blackPen, 5, 28, 205, 28);
                messageFont = new Font("Times New Roman", 12, System.Drawing.GraphicsUnit.Point);
                g.DrawString("Dated: " + dateTimePicker1.Value.Date.ToString("dd MMM, yyyy"), messageFont, Brushes.Black, 150, 32);
            ...
            for (; i < dataGridView1.Rows.Count; i++)
            {
                ...
                medicine med = new medicine();
                med.dispMonthlyExpenses(monthCalendar1.SelectionRange.Start.ToString("yyyyMM") + "01",monthCalendar1.SelectionRange.Start.AddMonths(1).ToString("yyyyMM") + "01", dataGridView1.Rows[i].Cells[0].Value.ToString());
        ...
        private void printDocument4_PrintPage(object sender, System.Drawing.Printing.PrintPageEventArgs e)
        {
            ...
            if (i == 0)
            {
                ...
                g.DrawString("INDIAN INSTITUTE OF TECHNOLOGY ROORKEE, SAHARANPUR CAMPUS", messageFont, Brushes.Black, 22, 15);
                messageFont = new Font("Times New Roman", 15, System.Drawing.GraphicsUnit.Point);
                g.DrawString("ANNUAL EXPENSE REPORT ( APRIL, " + comboBox1.SelectedItem.ToString() + " - MARCH, " + (Convert.ToInt32(comboBox1.SelectedItem.ToString()) + 1) + ")", messageFont, Brushes.Black, 40, 21);
                Pen blackPen = new Pen(Color.Black, 1);
                g.DrawLine(blackPen, 5, 28, 205, 28);
                messageFont = new Font("Times New Roman", 12, System.Drawing.GraphicsUnit.Point);
                g.DrawString("Dated: " + dateTimePicker1.Value.Date.ToString("dd MMM, yyyy"), messageFont, Brushes.Black, 150, 32);
            ...
            for (; i < dataGridView1.Rows.Count; i++)
            {
                ...
                medicine med = new medicine();
                med.dispMonthlyExpenses(comboBox1.SelectedItem.ToString() + "0401", (Convert.ToInt32(comboBox1.SelectedItem.ToString()) + 1).ToString() + "0401", dataGridView1.Rows[i].Cells[0].Value.ToString());
                string issued = med.issued;
                string received = med.received;
                if (issued == "")
                {
        ...
        private void printDocument5_PrintPage(object sender, System.Drawing.Printing.PrintPageEventArgs e)
        {
            ...
            if (i == 0)
            {
                ...
                g.DrawString("INDIAN INSTITUTE OF TECHNOLOGY ROORKEE, SAHARANPUR CAMPUS", messageFont, Brushes.Black, 22, 15);
                messageFont = new Font("Times New Roman", 15, System.Drawing.GraphicsUnit.Point);
                g.DrawString("DISPENSARY - COMPLETE EXPENSE REPORT ( 05 April, 2013 - " + DateTime.Today.ToString("dd MMMM, yyyy") + ")", messageFont, Brushes.Black, 10, 21);
                Pen blackPen = new Pen(Color.Black, 1);
                g.DrawLine(blackPen, 5, 28, 205, 28);
                messageFont = new Font("Times New Roman", 12, System.Drawing.GraphicsUnit.Point);
                g.DrawString("Dated: " + dateTimePicker1.Value.Date.ToString("dd MMM, yyyy"), messageFont, Brushes.Black, 150, 32);
            ...
            for (; i < dataGridView1.Rows.Count; i++)
            {
                ...
                medicine med = new medicine();
                med.dispMonthlyExpenses("20130404", DateTime.Now.AddDays(1).ToString("yyyyMMdd"), dataGridView1.Rows[i].Cells[0].Value.ToString());
                string issued = med.issued;
                string received = med.received;
                if (issued == "")
                {
